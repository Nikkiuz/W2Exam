...
cars.push({brand: 'Audi', model: 'Q7', color:'white', trims:['GT', 'classy']})
// console.log(cars)
...
for (let i = 0; i < cars.length; i++){
  justTrims.push(cars[i].trims.at(0))
...
for (i = 0; i < numericArray.length; i++){
  if (numericArray[i] < 32 ){
    console.log(numericArray[i].valueOf()) 
    
  } 
}
  

//  l'ho fatto con FOR perchè con while entravo nel "loop della morte".
